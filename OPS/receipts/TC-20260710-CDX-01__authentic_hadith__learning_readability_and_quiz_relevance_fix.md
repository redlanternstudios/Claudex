...
VERIFIED: The current app fix is commit `55997e4` on branch `fix/repair-batch-2026-06-25`.
...
PARTIAL: Learning readability is fixed in code and simulator. Build 106 should be treated as superseded. Next build must be build 107 or later from commit `55997e4` before Keymon submits App Review.

## Next Action

Build and submit a new iOS binary from commit `55997e4`, then run TestFlight learning flow proof before marking Authentic Hadith ready for App Review.
