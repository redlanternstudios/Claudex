...
## ACTIVE PRODUCT
Amina remains Rory's primary active product for the iOS push. KP owns TheLanternDaily.com. Claudex now has one canonical signal first backlog and is adding an automatic capture and ship loop for verified reusable system advances. Footprint strategy and the marketing engine remain parallel owner work.

## CURRENT SPRINT GOAL
Ship the Claudex capture and ship loop without changing product authority, then continue the Amina and Lantern owner lanes from the ranked heartbeat.
...
## TOP 3 TASKS
1. Codex: ship and verify the automatic Claudex capture and ship loop.
...
## SINGLE NEXT ACTION
Codex completes the capture and ship skill, full check, TruthCal receipt, and GitHub publication.
...
---
*Refreshed 2026-07-16 by Codex for the authorized capture and ship loop. Existing open directives remain open where proof is missing.*
